        ...
        <main v-else class="pack-list">
            ...
            <div class="list-container">
                <table class="list" v-if="selectedPackLevels">
                    <tr v-for="(level, i) in selectedPackLevels">
                        <td class="rank">
                            <p class="type-label-lg">#{{ selectedPackLevels[i][0].listRank }}</p>
                        </td>
            ...
            <div class="level-container">
                <div class="level" v-if="selectedPackLevels[selectedLevel][0]">
                    ...
                    <h2>Records</h2>
                    <p v-if="selected <= 100"><strong>{{ selectedPackLevels[selectedLevel][0].level.percentToQualify }}%</strong> or better to qualify</p>
